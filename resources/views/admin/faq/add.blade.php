...
@section('content')
    ...
    <div class="card shadow mb-3">
        <div class="card-body">
            <form action="{{ route('admin.faq.add') }}" method="post" enctype="multipart/form-data"
                id="add-faq">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <input type="text" name="q" id="q" required class="form-control" required>
                    </div>
                  
                    <div class="col-md-12 mb-2">
                        <label for="a">Answer</label>
                        <textarea name="a" id="a"  rows="4" class="form-control desc"></textarea>
                    </div>
