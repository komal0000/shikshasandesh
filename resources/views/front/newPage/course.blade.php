            ...
            <div class="course-slider-active-3">
                <div class="single-course">
                    ...
                    <div class="course-content">
                        <h4><a href="{{ route('courseDeatil') }}">Apparel Manufacturing</a></h4>
                ...
                <div class="single-course">
                    <div class="course-img">
                        <a href="{{ route('courseDeatil') }}"><img class="animated"
                                src="	https://htmldemo.net/glaxdu/glaxdu/assets/img/course/course-2.jpg" alt=""></a>
                    </div>
                    <div class="course-content">
                        <h4><a href="{{ route('courseDeatil') }}">Grphic Design & Multimedia</a></h4>
                        <p>magna aliqua. Ut enim ad minim veniam, nisi ut aliquiptempor incid.</p>
                    </div>
                    <div class="course-position-content">
                        <div class="credit-duration-wrap">
                ...
                <div class="single-course">
                    <div class="course-img">
                        <a href="{{ route('courseDeatil') }}"><img class="animated"
                                src="	https://htmldemo.net/glaxdu/glaxdu/assets/img/course/course-3.jpg" alt=""></a>
                    </div>
                    <div class="course-content">
                        <h4><a href="{{ route('courseDeatil') }}">Computer Engineering</a></h4>
                        <p>magna aliqua. Ut enim ad minim veniam, nisi ut aliquiptempor incid.</p>
                    </div>
                    <div class="course-position-content">
                        <div class="credit-duration-wrap">
                ...
                <div class="single-course">
                    <div class="course-img">
                        <a href="{{ route('courseDeatil') }}"><img class="animated"
                                src="	https://htmldemo.net/glaxdu/glaxdu/assets/img/course/course-4.jpg" alt=""></a>
        ...
        <div class="container">
            ...
            <div class="course-slider-active-4">
                ...
                <div class="single-course">
                    <div class="course-img">
                        <a href="{{ route('courseDeatil') }}"><img class="animated"
                                src="	https://htmldemo.net/glaxdu/glaxdu/assets/img/course/course-2.jpg"
                                alt=""></a>
                    </div>
                    <div class="course-content">
                        <h4><a href="{{ route('courseDeatil') }}">Grphic Design & Multimedia</a></h4>
                ...
                <div class="single-course">
                    <div class="course-img">
                        <a href="{{ route('courseDeatil') }}"><img class="animated"
                                src="	https://htmldemo.net/glaxdu/glaxdu/assets/img/course/course-3.jpg"
                                alt=""></a>
                    </div>
                    <div class="course-content">
                        <h4><a href="{{ route('courseDeatil') }}">Computer Engineering</a></h4>
