...
<head>
    ...
    <link href="{{asset('css/bootstrap.min.cs')}}s" rel="stylesheet">
        ...
        <div class="row g-5">
            ...
            <div class="col-lg-3 col-md-6">
                ...
                <div class="row g-2 pt-2">
                    ...
                    <div class="col-4">
                        <img class="img-fluid bg-light p-1" src="{{asset('img/course-2.jp')}}g" alt="">
                    </div>
                    <div class="col-4">
                        <img class="img-fluid bg-light p-1" src="{{asset('img/course-3.jpg')}}" alt="">
                    </div>
        ...
        <div class="copyright">
            <div class="row">
                <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                    &copy; <a class="border-bottom" href="#">Arniko</a>, All Right Reserved.

                    <!--/*** This template is free as long as you keep the footer author’s credit link/attribution link/backlink. If you'd like to use the template without the footer author’s credit link/attribution link/backlink, you can purchase the Credit Removal License from "https://htmlcodex.com/credit-removal". Thank you for your support. ***/-->
                    Designed By <a class="border-bottom" href="#">Need Technosoft </a><br><br>
